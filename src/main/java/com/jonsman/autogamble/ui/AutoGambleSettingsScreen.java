...
public final class AutoGambleSettingsScreen extends Screen {
    ...
    @Override public void extractRenderState(GuiGraphicsExtractor g, int mx, int my, float delta) {
        ...
        g.centeredText(font, "1.3.0  •  " + (draft.working.dryRunMode ? "DRY RUN — no real payments" : "REAL PAYMENTS") + "  •  Save to apply", width / 2, 30, draft.working.dryRunMode ? 0xFF99DDCC : 0xFFFFBB66);
