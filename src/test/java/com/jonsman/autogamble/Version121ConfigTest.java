...
class Version121ConfigTest {
    ...
    @Test void newDefaultsAreSafeAndDocumented() {
        var c=new AutoGambleConfig();assertEquals(10,c.configVersion);assertTrue(c.paymentSoundAlertsEnabled);
    ...
    @Test void versionSixMigrationPreservesSettingsAndAddsDefaults() throws Exception {
        ...
        assertEquals(10,c.configVersion);assertFalse(c.dryRunMode);assertEquals(77,c.autoPayAmount);assertEquals(.31,c.winChance);assertTrue(c.autoFollowGoodCustomersEnabled);assertTrue(c.paymentSoundAlertsEnabled);
    }
