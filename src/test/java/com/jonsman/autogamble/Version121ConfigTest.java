...
class Version121ConfigTest {
    ...
    @Test void newDefaultsAreSafeAndDocumented() {
        var c=new AutoGambleConfig();assertEquals(12,c.configVersion);assertTrue(c.paymentSoundAlertsEnabled);
    ...
    @Test void versionSixMigrationPreservesSettingsAndAddsDefaults() throws Exception {
        ...
        assertEquals(12,c.configVersion);assertFalse(c.dryRunMode);assertEquals(77,c.autoPayAmount);assertEquals(.31,c.winChance);assertTrue(c.autoFollowGoodCustomersEnabled);assertTrue(c.paymentSoundAlertsEnabled);
    }
